...
![ポートフォリオ実例](./images/18-portfolio-examples.png)

営業するときは、制作実績を1つずつ説明するより、まずポートフォリオURLを見せるほうが早いです。

実例として、以下のようなポートフォリオを用意します。
...
このポートフォリオには、以下のような制作物を載せています。

- ハル整骨院  
  整骨院向けに、信頼感、予約導線、スマホ体験を重視したLP。

- 整備工場のサービスサイト  
  地域の自動車整備工場向けに、信頼感と問い合わせ導線を重視したサービスサイト。

- 佐賀アグリテック  
  農業法人を想定し、地域性とテクノロジー感を組み合わせたコーポレートサイト。

- 製造業コーポレートサイト  
  町工場や製造業向けに、技術力と誠実さが伝わるように設計したサイト。

- 保険営業サイト  
  保険相談、ライフプラン相談を想定した、信頼感と相談導線を重視したLP。

- トレマチ  
  トレカのマッチングサービスとして、コレクター同士の交換、売買をつなぐ体験を設計したWebサービス。

- ChotGPT ランディングページ  
  気軽に話しかけられるAIチャットサービスのLP。
...
整体院、整備工場、農業法人、製造業、保険営業サイトなど、
小規模事業者向けの問い合わせ導線を意識したLP / Webサイトを掲載しています。
```

相手の業種に近い実績がある場合は、その実績だけを一言添えると反応が上がりやすくなります。

例：

```text
整体院向けのLP実績もありますので、
近い雰囲気の参考としてこちらをご覧ください。
https://tagit-six.vercel.app/
```
